...
public class FlightApp {
	...
	public int getTotalCount() {
		...
		if (flightInfo == null)
			...
			////// for debug only ////////
//			System.out.println(flightInfo.getResponse());
//			System.out.println(flightInfo.getResponse().getBody());
//			System.out.println(flightInfo.getResponse().getBody().getTotalCount());
//			
